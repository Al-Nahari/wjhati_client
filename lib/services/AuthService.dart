...
class AuthService {
  ...
  static const String _loginUrl = 'http://192.168.1.2:8000/api/token/';
  // نقطة النهاية الخاصة بالتسجيل
  static const String _registerUrl = 'http://192.168.1.2:8000/api/register/';
  // نقطة النهاية الخاصة بتحديث رمز الوصول
  static const String _refreshUrl = 'http://192.168.1.2:8000/api/token/refresh/';
